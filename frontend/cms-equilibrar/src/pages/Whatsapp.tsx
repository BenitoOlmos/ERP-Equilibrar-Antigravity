...
import { Search, Send, User, MessageCircle, Bot, Power, PowerOff, Building, CheckCircle, Clock, Mail, Phone, FileText, Calendar, Plus, ChevronLeft, ChevronRight } from 'lucide-react';
